...
CREATE TABLE `itenspedido` (
  `iditens` bigint NOT NULL AUTO_INCREMENT,
  `idpedido` bigint NOT NULL,
  `idproduto` bigint NOT NULL,
  `quantidade` int DEFAULT '1',
  `subtotal` decimal(10,2) NOT NULL,
  PRIMARY KEY (`iditens`),
  KEY `fk_itenspedido_pk_pedido` (`idpedido`),
  KEY `fk_itenspedido_pk_produto` (`idproduto`)
...
INSERT INTO `itenspedido` VALUES (1,1,1,5,254.50);
